            ...
            <div class="d-flex justify-content-start mb-3">
                ...
                <div class="d-flex flex-column my-auto">
                    ...
                    <div class="d-flex">
                        ...
                        <span class="my-auto" style="font-size:14px">Rover was successfully deployed to <span style="font-weight:600">x: {{ $mission->rover_starting_x }}</span> <span style="font-weight:600">y: {{ $mission->rover_starting_y }}</span> facing <span style="font-weight:600">{{ ucfirst($mission->rover_starting_orientation) }}</span></span>
                    </div>
                    <div class="d-flex">
                        <div class="my-auto mr-2" style="background: red; width: 10px; height: 10px"></div>
                        <span class="my-auto" style="font-size:14px">Obstacles found nearby and sent to mission map.</span>
                    </div>
                </div>
                <div class="my-auto ml-4 flex-grow-1">
                    <p class="mb-1" style="font-weight: bold; font-size: 14px;">Enter a collection of commands</p>
                    <textarea style="resize:none" class="form-control form-control-sm" rows="2"></textarea>
                </div>
            </div>
